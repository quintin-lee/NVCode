return {
    ...
    config = function()
        ...
        wk.add({
            ...
            { "<leader>aca", "<cmd>CodeCompanionActions<cr>",                 desc = "Actions Palette",                                  mode = { "n", "v" } },
            { "<leader>act", "<cmd>CodeCompanionChat Toggle<cr>",             desc = "Toggle Chat",                                      mode = { "n", "v" } },
            { "<leader>aci", "<cmd>CodeCompanion<cr>",                        desc = "Inline Assistant",                                 mode = { "n", "v" } },
            { "ga",          "<cmd>CodeCompanionChat Add<cr>",                desc = "Add to AI Context",                                mode = "v" },
            { "<leader>aca", "<cmd>CodeCompanionActions<cr>",                 desc = "AI Actions Palette" },
            { "<leader>act", "<cmd>CodeCompanionChat Toggle<cr>",             desc = "Toggle AI Chat" },
            { "<leader>acs", "<cmd>CodeCompanionChat Add<cr>",                desc = "Add Selection to AI Chat" },
            { "<leader>aci", "<cmd>CodeCompanion<cr>",                        desc = "Inline AI Assistant" },
            ...
            { "<leader>lf",  function() require("conform").format({ async = true, timeout_ms = 1000 }) end, desc = "Format" },
            ...
            {
                "<leader>sl",
                "<cmd>e " .. config_home .. "/lua/configs/lsp_config.json<cr>",
                desc = "Open LSP Configuration File",
            },
